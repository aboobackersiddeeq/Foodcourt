...
router.get('/add-category', verifyAdmin, adminController.getaddCatogory);
router.post('/add-category', verifyAdmin, adminController.addCatogory);
...
router.post('/edit-coupon/:id', verifyAdmin, adminController.editCoupon);
router.get('/view-orders', verifyAdmin, adminController.viewOrders);
router.get('/change-status', verifyAdmin, adminController.changeStatus);
router.get('/sales-report', verifyAdmin, adminController.salesReport);
router.get('/month-report', verifyAdmin, adminController.monthReport);
router.get('/year-report', verifyAdmin, adminController.yearReport);
